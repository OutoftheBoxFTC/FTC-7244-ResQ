...
public abstract class FourWheelDriveBase extends OpMode {
    ...
    /**
     * This constuctor is used to initialize the robot. It is intended for all child classes to call
     * this constuctor using .super()
     *
     * @param motorName1 The name to map motor1 to.
     * @param motorName2 The name to map motor2 to.
     * @param motorName3 The name to map motor3 to.
     * @param motorName4 The name to map motor4 to.
     */
