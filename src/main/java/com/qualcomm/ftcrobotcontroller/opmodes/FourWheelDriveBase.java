...
public abstract class FourWheelDriveBase extends OpMode {
    ...
    public void setDriveMotorNames(String motorName1, String motorName2, String motorName3, String motorName4) {
     ...
     * unless needed, as most maneuvers will not require setting each motor separately.
     *
    ...
    public boolean getJoyButtonB() {return gamepad1.b;}
    ...
    public boolean getOpJoyButtonX() {return gamepad2.x;}

    public boolean getOpJoyButtonB() {return gamepad2.b;}

    public boolean getOpJoyButtonA() {return gamepad2.a;}


    public boolean getOpLeftBumper() {return gamepad2.left_bumper;}

    public boolean getOpRightBumper() {return gamepad2.right_bumper;}
